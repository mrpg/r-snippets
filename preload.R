# https://github.com/mrpg/r-snippets @ 2025-11-21
# Licensed under GNU GPL v3.0 (due to GPL dependencies: texreg, lmtest, sandwich)
...
gencorr <- function(n, rho, means = c(0, 0), sds = c(1, 1)) {
    library(MASS)

    Sigma <- matrix(c(sds[1]^2, rho*sds[1]*sds[2],
                      rho*sds[1]*sds[2], sds[2]^2),
                    2,
                    2)
